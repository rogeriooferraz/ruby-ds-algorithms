...
describe Graph do
  ...
  it "Test Case 2 - Depth-First Search (DFS) Traversal" do
  ...
  it "Test Case 3 - BFS Pathlist" do
  ...
  it "Test Case 4 - DFS Pathlist" do
  ...
  it "Test Case 4 - BFS Shortest Path" do
  ...
  it "Test Case 6 - DFS Shortest Path" do
